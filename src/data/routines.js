export const DEFAULT_ROUTINES = [
  // --- KETTLEBELL ROUTINES ---
  {
    ...
    description: 'Explosive kettlebell conditioning flow featuring snatches, halos, Russian swings, cleans, Turkish get-ups, high pulls, and windmills.',
    estimatedMinutes: 32,
    ...
    exercises: [
      ...
      { exerciseId: 'kb-snatch', sets: 4, targetReps: 10, targetWeight: 14, restSec: 60 },
  ...
  },
  {
    ...
    category: 'Kettlebell',
    equipmentType: 'Kettlebell',
    description: 'High-intensity full body kettlebell workout targeting dynamic leg power, shoulder halos, snatch power, and core stability.',
    estimatedMinutes: 28,
    difficulty: 'Beginner',
    exercises: [
      { exerciseId: 'kb-halo', sets: 3, targetReps: 10, targetWeight: 10, restSec: 45 },
      { exerciseId: 'kb-goblet-squat', sets: 4, targetReps: 12, targetWeight: 16, restSec: 60 },
      { exerciseId: 'kb-swings', sets: 4, targetReps: 15, targetWeight: 16, restSec: 45 },
      { exerciseId: 'kb-snatch', sets: 3, targetReps: 8, targetWeight: 12, restSec: 60 },
